...
$(() => {
            ...
            callback: function () {
                ...
                $(".dlg_btn").unbind().bind("click", function () {
                    if ($.trim($("input[name='company_name']").val()) != "") {
                        $.ajaxForJson(config.wwwPath + "/getCompanyByName", {
                            ...
                            if (dataObj.code == "2000") {
                                ...
                                $(".js_dlgInvite").unbind().bind("click", function () {
                                    ...
                                    $.ajaxForJson(config.wwwPath + "/addSeat", {
    ...
    $(".inviteAgree,.inviteRefuse,.js_reinvite").unbind().bind("click", function () {
        ...
        $.cueDialog({
            ...
            content: '',
            callback: function () {
                $.ajaxForJson(config.wwwPath + "/dealInvitation", {
                    id: id,
                    status: status
                }, function (dataObj) {
                    if (dataObj.code == "2000") {
    ...
    $(".js_remove").unbind().bind("click", function () {
        ...
        $.cueDialog({
            ...
            content: '',
            callback: function () {
                $.ajaxForJson(config.wwwPath + "/delSeat", {
                    id: id
                }, function (dataObj) {
                    if (dataObj.code == "2000") {
                        $.msgTips({
    ...
    $(".btn_confirm").unbind().bind("click", function () {
        ...
        $.ajaxForJson(config.wwwPath + "/setSeat", {
            bCode: code
        }, function (dataObj) {
            if (dataObj.code == "2000") {
                $.msgTips({
