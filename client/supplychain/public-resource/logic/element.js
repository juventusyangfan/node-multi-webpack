    ...
    $.fn.extend({
        ...
        initSelect: function () {
            $(this).each(function () {
                ...
                var selHTML = '<div class="cjy-select" style="width: ' + selW + 'px;"><div class="cjy-select-title"><input type="text" placeholder="' + placeholder + '" value="' + text + '" ' + readOnly + ' class="cjy-select-input" style="width: ' + (selW - 40) + 'px;' + bgStyle + '"><i class="iconfont icon-xiajiantou"></i></div><dl style="width: ' + selW + 'px;">';
                ...
                select.next(".cjy-select").find("dd").unbind().bind("click", function () {
                    ...
                    if (select.next(".cjy-select").next("input").length <= 0) {
                        ...
                        select.next(".cjy-select").next("input").val(opTxt);
                    }
                    select.trigger("change");
                });
                if (readOnly == "") {
