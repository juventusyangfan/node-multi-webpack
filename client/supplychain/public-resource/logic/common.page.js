...
$(() => {
    ...
    (function ($) {
        $.fn.html2PDF = function (callback) {
            ...
            html2canvas(conObj, {
                ...
                var doc = new jsPDF('', 'in', [canWidth / dpiX, canHeight / dpiY]);//设置PDF宽高为要显示的元素的宽高，将像素转化为英寸
    ...
    // 融资申请
    $.fn.intentionFormFuc = function () {
        $.ajaxForJson(config.jcPath + 'Product/ajaxDefaultInfo', null, function (json) {
            if (json.code == 2000) {
                $.dialog({
                    title: '融资申请',
                    content: '<div><form class="intention_form"><div class="back_main_item"><label>客户姓名：</label><div class="back_main_block"><input name="client_real_name" type="text" class="cjy-input-" placeholder="请输入客户姓名" autocomplete="off" maxlength="10" value="' + json.data.client_real_name + '"></div></div><div class="back_main_item"><label>公司名称：</label><div class="back_main_block"><input  type="text" class="cjy-input-" disabled value="' + json.data.client_company_name + '"></div></div><div class="back_main_item"><label>客户电话：</label><div class="back_main_block"><input name="client_mobile" type="text" class="cjy-input-" placeholder="请输入客户电话" autocomplete="off" maxlength="20"value="' + json.data.client_mobile + '"></div></div><div class="back_main_item"><label>意向金额：</label><div class="back_main_block"><input name="apply_amount" type="text" class="cjy-input-" autocomplete="off" maxlength="9"><span>&nbsp;&nbsp;万元</span></div></div><div class="back_main_item"><label>期望年利率：</label><div class="back_main_block"><input name="apply_rate" type="text" class="cjy-input-" autocomplete="off" maxlength="5"><span>&nbsp;&nbsp;%</span></div></div><div class="back_main_item"><label>还款期限：</label><div class="back_main_block"><input name="apply_back_month" type="text" class="cjy-input-" autocomplete="off" maxlength="4"><span>&nbsp;&nbsp;个月</span></div></div><div class="back_main_item"><label>放款时间：</label><div class="back_main_block"><input name="apply_loan_day" type="text" class="cjy-input-" autocomplete="off" maxlength="4"><span>&nbsp;&nbsp;天</span></div></div></form></div>',
                    width: 650,
                    confirm: {
                        show: true,
                        allow: true,
