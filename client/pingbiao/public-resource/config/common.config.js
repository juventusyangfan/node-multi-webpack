...
if (IS_PRODUCTION) {
    ...
    moduleExports.bidPath = 'https://bid.dev.materialw.com/';
    ...
    moduleExports.pingbiaoPath = 'https://pingbiao.dev.materialw.com/';
    moduleExports.pullPath = 'https://pull.dev.materialw.com/';
