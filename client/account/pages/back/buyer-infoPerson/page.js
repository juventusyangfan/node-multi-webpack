...
$(() => {
    // 点击滑动到相应的位置
    $(".back_info_item label").on("click", "a", function () {
        var barclass = $(this).attr('href');
    ...
    $(".js_psd").off().on("click", function () {
        ...
        var reqUrl = config.accountPath + $("form").eq(0).attr("action");
    ...
    $(".sendCode").unbind().bind("click", function () {
        ...
        if (setCode) {
            ...
            $.ajaxForJson(config.accountPath + "/account/sendSms", {
    ...
    $(".is_tel").off().on("click", function () {
        ...
        var reqUrl = config.accountPath + $("form").eq(1).attr("action");
    ...
    $(".sendEmail").unbind().bind("click", function () {
        ...
        if (setEmailCode) {
            $.ajaxForJson(config.accountPath + "/account/sendEmailCode", {
    ...
    $(".is_email").off().on("click", function () {
        ...
        var reqUrl = config.accountPath + formObj.attr("action");
